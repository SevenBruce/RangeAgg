public class Params {
	...
	public final static int EXPERIMENT_TIMES = 500; /* times of running the experiments */
...
//	public static int ARRAY_OF_METERS_NUM[] = {3}; /* number of smart meters */
	public static int METERS_NUM = 20; /* number of smart meters */; /* number of smart meters */
	
	public static int UPBOUND_LIMIT_OF_METER_DATA = 1000; /* upper bound of the reporting system */
